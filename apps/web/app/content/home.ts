export const homeContent = {
  ...
  story: {
    title: 'The Story',
    subtitle: "This Is Beepa's",
    content:
      'Beepa was the nickname of Walter Hopper, a Beloit native and the grandfather of our founder, Justin Fjalstad. Beepa was the kind of guy who worked with his hands, grew what he ate, and believed food tasted better when it was shared.\n\nHis garden was always full. His door was always open. And his way of doing things stuck.',
  },
  started: {
    title: 'How It Started',
    subtitle: 'From Garden Rows to Mason Jars',
    content:
      "Beepa showed Justin at an early age that good food doesn't need shortcuts. Years later, he started canning vegetables at home — the same way Beepa would've done it. No gimmicks. Just real ingredients and time put in.\n\nFriends tried it. Then friends of friends. Pretty soon, one jar turned into another, and Beepa's grew from there.\n\nIn the summer of 2019, Beepa’s took its products to the Wisconsin State Fair and swept the awards. Against more than 100 entries, the results spoke for themselves.",
    ...
    awardsLink: {
      href: 'https://www.wrex.com/news/positive-local-news/beepa-s-beans-in-beloit-sweeps-wisconsin-state-fair-eats-treats-competition/article_795d0c91-8faa-5f68-bd2d-fc0aa130fc81.html',
      text: "Read the WREX news story about Beepa's awards",
    },
  },
  whatWeMake: {
    title: 'What We Make',
    subtitle: 'Made Local. Made Right.',
    content:
    ...
    principles: [
      ...
      'Support local farmers and producers whenever possible.',
  ...
  closing: {
    title: 'Built on Family. Backed by Community.',
    content:
      "Beepa's is about honoring where you come from and supporting the people around you. It's about local work, local roots, and food that brings folks together after a long day.\n\nThis is Beepa's.\nThanks for supporting local.",
  },
};
